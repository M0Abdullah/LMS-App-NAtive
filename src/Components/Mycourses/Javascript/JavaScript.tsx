...
export default function App() {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          'https://4c00e3fe-188c-4fbd-8632-c2c8d8253b3c.mock.pstmn.io'
        );
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      {data.course.modules.map((module: { title: string | number | boolean | React.ReactElement<any, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | null | undefined; description: string | number | boolean | React.ReactElement<any, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | null | undefined; lessons: any[]; }, index: React.Key | null | undefined) => (
